  ...
  await createCol('orders', {
    $jsonSchema: {
      ...
      properties: {
        ...
        shippingAddress: {
          bsonType: 'object',
          required: ['fullName','mobileNumber','addressLine1','city','state','pincode'],
          properties: {
            fullName:              { bsonType: 'string' },
            mobileNumber:          { bsonType: 'string' },
            alternateMobileNumber: { bsonType: 'string' },
            phone:                 { bsonType: 'string' },
        ...
        orderStatus:   { bsonType: 'string', enum: ['Pending','Packed','Shipped','Delivered','Cancelled'] },
        shippingStatus:{ bsonType: 'string', enum: ['Pending','Confirmed','Shipped','Delivered','Cancelled'] },
        ...
        awbCode:            { bsonType: 'string' },
        courierName:        { bsonType: 'string' },
        trackingUrl:        { bsonType: 'string' },
        estimatedDeliveryDate: { bsonType: 'date' },
